...
class FurstBot:
    def __init__(self, api_id, api_hash, bot_token, log_channel_id):
        ...
        self.client = TelegramClient("FurstBotSession", self.api_id, self.api_hash).start(bot_token=self.bot_token)
    ...
    def run(self):
        ...
        print("Furst Bot is now running...")
...
if __name__ == "__main__":
    bot = FurstBot(API_ID, API_HASH, BOT_TOKEN, LOG_CHANNEL_ID)
    bot.run()
